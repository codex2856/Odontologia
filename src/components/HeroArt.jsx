/**
 * Abstract editorial artwork for the hero section: fine purple line-work
...
export default function HeroArt() {
  return (
    ...
    >
      <g className="hero-art__orbit" stroke="#8A6FA3" strokeOpacity="0.55">
        <circle cx="430" cy="180" r="150" strokeWidth="0.6" />
        <circle cx="430" cy="180" r="112" strokeWidth="0.6" />
        <circle cx="430" cy="180" r="1.5" fill="#5B3878" stroke="none" />
      </g>

      <g className="hero-art__hex" stroke="#7A529B" strokeOpacity="0.6" strokeWidth="0.7">
      ...
      <g className="hero-art__lines" stroke="#5B3878" strokeOpacity="0.6" strokeWidth="0.6">
      ...
      <g className="hero-art__dust" fill="#7A529B">
